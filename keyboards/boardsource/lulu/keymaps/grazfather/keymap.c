...
[0] = LAYOUT(
  ...
  KC_LSFT,        KC_Z,         KC_X,          KC_C,          KC_D,          KC_B,         KC_NO,        KC_NO,        KC_K,          KC_H,          KC_COMMA,      KC_DOT,        KC_SLASH,      KC_RSFT,
                                               KC_ESC,        KC_LALT,       KC_LGUI,      KC_SPC,       KC_BSPC,      LT(1,KC_ENTER),KC_NO,         KC_NO
),
/* Symbol layer
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[1] = LAYOUT(
  ...
  _______,        KC_NO,        KC_NO,         KC_NO,         KC_NO,         KC_NO,                                    KC_NO,         KC_LBRC,       KC_RBRC,       KC_EQL,        KC_NO,         KC_F12,
  _______,        KC_NO,        KC_NO,         KC_NO,         KC_NO,         KC_NO,                                    KC_NO,         KC_LPRN,       KC_RPRN,       KC_NO,         KC_NO,         KC_NO,
