...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_grazkb(
        ...
        _______,   XXXXXXX,   KC_LEFT,   KC_DOWN,   KC_RIGHT,  XXXXXXX,                                     XXXXXXX,   KC_LPRN,   KC_RPRN,   XXXXXXX,   XXXXXXX,   _______,
        _______,   KC_Z,      KC_X,      KC_C,      KC_D,      KC_B,                                        XXXXXXX,   KC_LCBR,   KC_RCBR,   XXXXXXX,   XXXXXXX,   _______,
